...
title NEXUS llama.cpp Low VRAM
cd /d "%~dp0"
...
REM Low-VRAM profile: fewer GPU layers, more work in RAM/CPU.
"%SERVER%" -m "%MODEL%" --alias nexus-local --host 127.0.0.1 --port 8080 --n-gpu-layers 8 --ctx-size 8192 --threads 8 --parallel 1
pause
